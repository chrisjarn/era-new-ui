  ...
  return (
    ...
    >
      <article className="dr-p-24 bg-white border border-dark-grey dr-rounded-20 transition-shadow duration-150 group-hover:shadow-[0_0_24px_8px_rgba(127,255,195,0.7)]">
        <h3 className="typo-h3 dr-text-28 text-off-white text-balance dr-mb-12">
          {post.title}
        </h3>
        {post.description && (
          <p className="typo-p dr-text-16 text-off-white text-pretty dr-mb-16">
            {post.description}
          </p>
        )}
        <div className="flex items-center justify-between typo-p dr-text-14 text-off-white">
