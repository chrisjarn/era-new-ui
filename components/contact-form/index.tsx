...
export function ContactForm() {
  ...
  return (
    <div className="bg-white border border-dark-grey dr-rounded-24 dt:dr-rounded-32 shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative">
      ...
      >
        ...
        <div className="dr-mb-24 dt:dr-mb-32 last:dr-mb-32 last:dt:dr-mb-40">
          <label
            htmlFor="name"
            className="typo-label-m block text-off-white dr-mb-8 dt:dr-mb-12 uppercase font-semibold tracking-[0.05em]"
          >
            Name
          </label>
          <input
            ...
            className={cn(
              'w-full dr-py-16 dr-px-20 dt:dr-py-18 dt:dr-px-24 bg-white border border-dark-grey dr-rounded-12 dt:dr-rounded-16 text-off-white font-[system-ui] dr-text-15 dt:dr-text-15 leading-[1.6] transition-all duration-300 ease-out-cubic placeholder:text-light-gray focus:outline-none focus:border-teal focus:shadow-[0_0_0_4px_rgba(32,184,205,0.1)] hover:border-teal',
              errors.name &&
        ...
        <div className="dr-mb-24 dt:dr-mb-32 last:dr-mb-32 last:dt:dr-mb-40">
          <label
            ...
            className="typo-label-m block text-off-white dr-mb-8 dt:dr-mb-12 uppercase font-semibold tracking-[0.05em]"
          >
            What's your use case for ERA Safety?
          </label>
          <textarea
            id="useCase"
            ...
            placeholder="Tell us about your facility and emergency management needs..."
            rows={4}
            required
        ...
        {process.env.NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY && (
          <div
            ref={turnstileRef}
            className={cn(
              s.turnstileContainer,
              turnstileVisible && s.turnstileContainerVisible,
              turnstileVisible && 'dr-mb-24 dt:dr-mb-32'
            )}
          />
        )}
