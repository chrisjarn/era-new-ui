...
This file provides detailed guidance for AI agents working with the ERA Safety blog system.
...
- **rehype-pretty-code** - Syntax highlighting with Shiki (themes: one-light/one-dark-pro)
...
- Syntax highlighting: one-light/one-dark-pro themes
...
│   ├── legacy-post-1/page.mdx
│   ├── legacy-post-2/page.mdx
